...
$family = "whitelist";
$familycomment = "whitelistcomment";
...
<?php
  ...
  putHtml('<h2>Whitelist Database Management:</h2>');
  ...
  putHtml('Whitelist&nbsp;Number:<input type="text" size="18" maxlength="24" name="cidnum" value="'.$ldb['key'].'" />');
  ...
  if (($n = count($db['data'])) > 0) {
    echo '<td class="dialogText" style="text-align: left; font-weight: bold;">', "Whitelist", "</td>";
    ...
    for ($i = 0; $i < $n; $i++) {
      ...
      echo '<td>', whitelistaction($db['data'][$i]['value']), '</td>';
