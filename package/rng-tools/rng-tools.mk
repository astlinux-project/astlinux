...
RNG_TOOLS_JITTERENTROPY_VERSION = 3.0.0
...
## curl -L -o dl/rng-tools-jitterentropy-3.0.0.tar.gz https://github.com/smuellerDD/jitterentropy-library/archive/v3.0.0.tar.gz
## ./scripts/upload-dl-pair dl/rng-tools-jitterentropy-3.0.0.tar.gz
##
