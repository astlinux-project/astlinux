...
RNG_TOOLS_JITTERENTROPY_VERSION = 2.2.0
...
## curl -L -o dl/rng-tools-jitterentropy-2.2.0.tar.gz https://github.com/smuellerDD/jitterentropy-library/archive/v2.2.0.tar.gz
## ./scripts/upload-dl-pair dl/rng-tools-jitterentropy-2.2.0.tar.gz
##
